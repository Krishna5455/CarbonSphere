...
import { Navigation, Truck, Fuel, Clock } from 'lucide-react';
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#1e332f] pb-4">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 mb-2">
              ...
              <span>Step 3: Logistics</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">
              Freight Route & Logistics
            </h1>
            <p className="text-xs text-gray-400 mt-0.5">
              Road corridor and transit emissions to destination facility
            </p>
          </div>
            ...
            <div className="glass-panel p-5 rounded-2xl border border-emerald-500/30 space-y-4">
              <div className="flex items-center justify-between border-b border-[#1e332f] pb-3">
                ...
                <span className="text-[10px] px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-300 font-mono">
                  {selectedCandidate.facility_id === result.recommended_facility_id ? 'Optimal Transit' : 'Alternative Transit'}
                </span>
              </div>
              ...
              <div className="space-y-3 text-xs">
                ...
                <div className="ml-1.5 pl-3 border-l-2 border-dashed border-[#1e332f] py-1 text-[11px] text-gray-400">
                  <span className="font-mono text-emerald-400 font-bold">{selectedCandidate.distance_km.toFixed(1)} km</span> road transit
                </div>
                ...
                {result.ranked_candidates.map((c) => (
                  ...
                  >
                    ...
                    <div className="flex justify-between text-[10px] text-gray-400 mt-1">
                      <span>{c.distance_km.toFixed(1)} km transit</span>
