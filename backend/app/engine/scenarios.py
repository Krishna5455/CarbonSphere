...
from ..schemas.domain import DemoScenario, WasteStreamInput, PathwayType
...
DEMO_SCENARIOS: List[DemoScenario] = [
    DemoScenario(
        ...
        waste_input=WasteStreamInput(
            ...
            generator_name="Baramati Agro Cooperative FPO",
    ...
    DemoScenario(
        ...
        description="High-moisture brewery, beverage, and food canning sludge from an industrial corridor. High wet organic fraction (82%) makes it ideal for continuous anaerobic digestion.",
        waste_input=WasteStreamInput(
            title="40 Tonnes Food Processing Wet Residue",
            generator_name="Chakan Agro-Processing Industrial Hub",
    ...
    DemoScenario(
        ...
        waste_input=WasteStreamInput(
            ...
            generator_name="Satara Packaging Solutions Works",
